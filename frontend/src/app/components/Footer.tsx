      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><Link href="/documentation" className="text-base text-gray-600 hover:text-gray-900">Guides</Link></li>
              <li><Link href="/tutorials" className="text-base text-gray-600 hover:text-gray-900">Tutorials</Link></li>
              <li><Link href="/api" className="text-base text-gray-600 hover:text-gray-900">API</Link></li>
